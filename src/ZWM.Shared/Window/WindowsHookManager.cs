...
{
    public delegate void WindowFocusDelegate(Window window);
    public delegate void WindowDelegate(Window window);
    public delegate void WindowCreateDelegate(Window window, bool firstCreate);
    public delegate void WindowUpdateDelegate(Window window, WindowUpdateType type);
    ...
    public class WindowsHookManager
    {
        ...
        public WindowsHookManager()
        {
            _windows = new Dictionary<IntPtr, Window>();
            _floating = new Dictionary<Window, bool>();
        ...
        private string GenerateWindowDebugOutput(Window window)
        {
        ...
        private void HandleWindowFocused(Window window)
        {
            WindowFocused?.Invoke(window);
        }

        private void HandleWindowMoveStart(Window window)
        {
        ...
        private void HandleWindowAdd(Window window, bool firstCreate)
        {
            WindowCreated?.Invoke(window, firstCreate);
        }

        private void HandleWindowRemove(Window window)
        {
