...
namespace workspacer
{
    ...
    public class Workspace
    {
        ...
        public IList<Window> ManagedWindows
        {
            get
            {
                lock (_windows)
        ...
        public Window LastFocusedWindow => _lastFocused;
        ...
        private Window _lastFocused;

        public Workspace(ConfigContext context, string name, ILayoutEngine[] layoutEngines)
        {
            _context = context;
        ...
        public void AddWindow(Window window, bool layout = true)
        {
            lock (_windows)
            {
        ...
        public void RemoveWindow(Window window, bool layout = true)
        {
            lock (_windows)
            {
        ...
        public void UpdateWindow(Window window, WindowUpdateType type, bool layout = true)
        {
        ...
        public void SwapWindowToPoint(Window window, int x, int y)
        {
            ...
            if (windows.Contains(window))
            {
                ...
                {
                    _Logger.Debug("SwapWindowToPoint[{0},{1} - {2}]", x, y, window);
        ...
        private IEnumerable<WindowLocation> CalcLayout()
        {
            var windows = ManagedWindows;
            var monitor = _context.WorkspaceContainer.GetCurrentMonitorForWorkspace(this);
            if (monitor != null)
        ...
        public void DoLayout()
        {
            ...
            if (_context.Enabled)
            {
                ...
                if (monitor != null)
                {
                    ...
                    using (var handle = _context.WindowsHook.DeferWindowsPos(windows.Count))
                    {
