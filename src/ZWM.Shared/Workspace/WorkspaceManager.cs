...
namespace workspacer
{
    ...
    public delegate void WindowAddedDelegate(Window window, Workspace workspace);
    public delegate void WindowUpdatedDelegate(Window window, Workspace workspace);
    public delegate void WindowRemovedDelegate(Window window, Workspace workspace);
    public delegate void WindowMovedDelegate(Window window, Workspace oldWorkspace, Workspace newWorkspace);
    public class WorkspaceManager
    {
        ...
        public Workspace FocusedWorkspace => _context.WorkspaceContainer
            .GetWorkspaceForMonitor(_context.MonitorContainer.FocusedMonitor);

        private Dictionary<Window, Workspace> _windowsToWorkspaces;
        ...
        public WorkspaceManager(ConfigContext context)
        {
            _context = context;
            _windowsToWorkspaces = new Dictionary<Window, Workspace>();
        }
        ...
        public void SwitchToWorkspace(Workspace targetWorkspace)
        {
        ...
        public void MoveAllWindows(Workspace source, Workspace dest)
        {
        ...
        public void AddWindow(Window window, bool firstCreate)
        {
            AddWindow(window, true, firstCreate);
        }

        private void AddWindow(Window window, bool switchToWorkspace, bool firstCreate)
        {
        ...
        private void AddWindowToWorkspace(Window window, Workspace workspace)
        {
        ...
        public void UpdateWindow(Window window, WindowUpdateType type)
        {
            if (_windowsToWorkspaces.ContainsKey(window))
            {
        ...
        private Workspace GetWorkspaceForWindowLocation(Window window)
        {
        ...
        public void InitializeWithState(WorkspaceState state, IEnumerable<Window> allWindows)
        {
