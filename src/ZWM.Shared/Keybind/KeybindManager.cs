...
namespace workspacer
{
    public partial class KeybindManager : IKeybindManager
    {
        ...
        public KeybindManager(ConfigContext context)
        {
            _context = context;
            _kbdHook = KbdHook;
...
You can either change your custom hotkey or reassign the default hotkey";
        ...
        public void SubscribeDefaults(KeyModifiers mod = KeyModifiers.LAlt)
        {
            ...
            Subscribe(mod, Keys.T,
                () => _context.WindowsHook.ToggleFocusedWindowTiling(), "toggle tiling for focused window");
            ...
            Subscribe(mod, Keys.O,
                () => _context.WindowsHook.DumpWindowDebugOutput(), "dump debug info to console for all windows");

            Subscribe(mod | KeyModifiers.LShift, Keys.O,
                () => _context.WindowsHook.DumpWindowUnderCursorDebugOutput(), "dump debug info to console for window under cursor");
