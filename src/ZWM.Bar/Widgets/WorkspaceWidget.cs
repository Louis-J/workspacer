...
namespace workspacer.Bar.Widgets
{
    public class WorkspaceWidget : BarWidgetBase
    {
        ...
        private ConcurrentDictionary<Workspace, bool> _blinkingWorkspaces;
        ...
        public override void Initialize()
        {
            ...
            _blinkingWorkspaces = new ConcurrentDictionary<Workspace, bool>();
        ...
        private bool WorkspaceIsIndicating(Workspace workspace)
        {
        ...
        private IBarWidgetPart CreatePart(Workspace workspace, int index)
        {
        ...
        protected virtual string GetDisplayName(Workspace workspace, int index)
        {
        ...
        protected virtual Color GetDisplayColor(Workspace workspace, int index)
        {
            var monitor = Context.WorkspaceContainer.GetCurrentMonitorForWorkspace(workspace);
